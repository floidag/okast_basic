...
function okast_profile_details() {
  return array(
    'name' => 'Okast Basic',
...
function okast_profile_tasks(&$task, $url) {
  install_include(okast_profile_modules());
  ...
  // Views
  install_views_ui_import_from_file('profiles/okast/backend_node_lists.view', 'backend_node_lists');
...
function okast_profile_modules() {
  return array(
...
*/
function okast_form_alter(&$form, $form_state, $form_id) {
